                            ...
                            expenses.map((expense) => (
                                <div key={expense.id} className="bg-base-100 px-6 py-4 rounded-sm border border-base-200 flex justify-between items-start transition-all duration-150 hover:border-primary/30 hover:shadow-sm">
                                    {editingId === expense.id ? (
                                        // Edit form for the expense
                                        <form onSubmit={(e) => { e.preventDefault(); saveEdit(expense.id); }} className="w-full">
                                            <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center w-full mb-4">
                                                <div className="flex-1">
                                                    <input
                                                        type="text"
                                                        value={editForm.item}
